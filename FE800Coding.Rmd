...
dt_overnight_ret_1_min <- subset(DTstockdata, dttweetflag == 1, overnight_1 == 1) ## select the subset of returns that are from close of business to opening of next business day
...
```{r STATISTICS DT}
##  Statistics about 1, 2, 5, 10, 20, 30, 60, 120, 240, and 360-minute returns
dt_max1 <- max(ret_1_min$ret_1_min) #max return
dt_min1 <- min(ret_1_min$ret_1_min) #min return
dt_mean1 <- mean(ret_1_min$ret_1_min) #mean
dt_sd1 <- sd(ret_1_min$ret_1_min) #standard deviation

dt_max2 <- max(ret_2_min$ret_2_min) #max return
dt_min2 <- min(ret_2_min$ret_2_min) #min return
dt_mean2 <- mean(ret_2_min$ret_2_min) #mean
dt_sd2 <- sd(ret_2_min$ret_2_min) #standard deviation

dt_max5 <- max(ret_5_min$ret_5_min) #max return
dt_min5 <- min(ret_5_min$ret_5_min) #min return
dt_mean5 <- mean(ret_5_min$ret_5_min) #mean
dt_sd5 <- sd(ret_5_min$ret_5_min) #standard deviation
